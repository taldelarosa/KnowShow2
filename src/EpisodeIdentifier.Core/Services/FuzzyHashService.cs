...
// Log search filter parameters
        ...
        if (_sharedConnection != null)
        {
            return await FindMatchesWithConnection(_sharedConnection, inputHashes, threshold, seriesFilter, seasonFilter);
        }
        else
        {
            ...
            try
            {
                return await FindMatchesWithConnection(connection, inputHashes, threshold, seriesFilter, seasonFilter);
            }
            finally
            {
